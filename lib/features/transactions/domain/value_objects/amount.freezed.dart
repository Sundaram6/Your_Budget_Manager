...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Amount&&(identical(other.value, value) || other.value == value));
}
...
class _Amount extends Amount {
  const _Amount(this.value): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Amount&&(identical(other.value, value) || other.value == value));
}
